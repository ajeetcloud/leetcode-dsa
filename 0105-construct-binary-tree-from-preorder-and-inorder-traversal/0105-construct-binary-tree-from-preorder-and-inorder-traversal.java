...
class Solution {
    ...
    private TreeNode dfs(int[] preorder, int[] inorder, int startIndexPre, int endIndexPre, int startIndexIn,
        ...
        */
        ...
        root.left = dfs(preorder, inorder, startIndexPre + 1, startIndexPre + elementsInLeftSubTree, startIndexIn,
                inOrderRootIndex - 1);
        root.right = dfs(preorder, inorder, startIndexPre + elementsInLeftSubTree + 1, endIndexPre,
                inOrderRootIndex + 1, endIndexIn);
